...
PRODUCT_COPY_FILES += \
    device/htc/ace/init.d/100complete:system/etc/init.d/100complete
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/ace/dsp/gps.conf:/system/etc/gps.conf
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/ace/kernel/modules/qc_pcm_in.ko:system/lib/modules/qc_pcm_in.ko
...
PRODUCT_COPY_FILES += \
    ...
    device/htc/ace/proprietary/eglsubAndroid.so:/system/lib/egl/eglsubAndroid.so \
    device/htc/ace/proprietary/libC2D2.so:/system/lib/libC2D2.so \
    device/htc/ace/proprietary/libOpenVG.so:/system/lib/libOpenVG.so \
    device/htc/ace/proprietary/libsc-a2xx.so:/system/lib/libsc-a2xx.so
